...
preprocess = ColumnTransformer(transformers=[ ("cat_transformer", cat_vals, cat_cols),("num_transformer", num_vals, num_cols)])
...
#Predict the pipeline on the test data = 0.7894736842105263
...
print(best_model.named_steps['pca'].get_params())

# 15. Print final accuracy score = 0.8157894736842105
